<?php
	...
	$req="SELECT * FROM vehicules WHERE marque LIKE ? OR modele LIKE ?";
	$req_execute=$bdd->prepare($req);
	$req_execute->execute(array("%".$motCle."%","%".$motCle."%"));
						...
						<div class="col-xs-3">
							...
							<div class="voitureDesc">
								...
								<center>
									...
									<a href="../Réserver/?id=<?php echo($data['id']); ?>" class="btn btn-warning btn-sm" style="width: 49%;">
