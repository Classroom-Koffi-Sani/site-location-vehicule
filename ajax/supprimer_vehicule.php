...
?>
<center>
	<h3><i class="fa fa-trash"> </i> Supprimer un véhicule</h3>
...
<div style="width: 60%;padding-left: 15px;">
	<table width="100%">
		<tr>
			<td width="240">
				Chercher un véhicule à Supprimer <i class="glyphicon glyphicon-triangle-right"> </i>
			</td>
			<td>
				<form id="search" method="post" action="recherche_supprimer/">
